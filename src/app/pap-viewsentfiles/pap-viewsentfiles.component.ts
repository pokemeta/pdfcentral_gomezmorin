...
@Component({
  selector: 'app-pap-viewsentfiles',
  templateUrl: './pap-viewsentfiles.component.html',
  styleUrls: ['./pap-viewsentfiles.component.css']
})
export class PapViewsentfilesComponent {
  user_id: any;
